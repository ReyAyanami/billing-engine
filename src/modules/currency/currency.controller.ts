...
export class CurrencyController {
  ...
  @ApiOperation({ 
    ...
    description: 'Returns all active currencies supported by the system (fiat and non-fiat)' 
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieves details of a specific currency by its code (e.g., USD, BTC)' 
  })
  @ApiParam({ name: 'code', description: 'Currency code (e.g., USD, EUR, BTC)', example: 'USD' })
  @ApiResponse({ status: 200, description: 'Currency found', type: Currency })
  @ApiResponse({ status: 400, description: 'Currency not supported or inactive' })
