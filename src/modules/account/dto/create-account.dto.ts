...
export class CreateAccountDto {
  @ApiProperty({
    description:
      'External identifier of the account owner (e.g., user ID, organization ID)',
    example: 'user_12345',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description:
      'Account subtype for categorization (e.g., bank, payment_gateway, cash, wallet)',
    example: 'wallet',
    required: false,
  })
  @IsString()
  ...
  @ApiProperty({
    description:
      'Maximum balance allowed for this account (for user accounts with limits)',
    example: '10000.00',
    required: false,
  })
  @IsNumberString()
